...
EXPR_OP_DEF(EXPR_O_IF    ,22        , u8"⁉"   , -2, NAN          )
EXPR_OP_DEF(EXPR_O_ELSE  ,23        , u8"✘"   , -2, NAN          )
EXPR_OP_DEF(EXPR_O_WHILE ,24        , u8"🔄"   , -2, NAN          )
EXPR_OP_DEF(EXPR_O_FOR   ,25        , u8"🔁"   , -2, NAN          )
EXPR_OP_DEF(EXPR_O_VDEF  ,26  | 0x80, u8"★"   , -1, NAN          )
EXPR_OP_DEF(EXPR_O_FDEF  ,27  | 0x80, u8"☆"   , -1, NAN          )
EXPR_OP_DEF(EXPR_O_CDEF  ,28  | 0x80, u8"✪"   , -1, NAN          )
//EXPR_OP_DEF(EXPR_O_RET   ,29  | 0x80, u8"🚪"   , 0, NAN          )
//EXPR_OP_DEF(EXPR_O_HALT  ,30  | 0x80, u8"🔌"   , 0, NAN          )
//EXPR_OP_DEF(EXPR_O_ERR   ,31 | 0x80, u8"🔫"   , 0, NAN          )
EXPR_OP_DEF(EXPR_O_EQRTL ,32       , u8"←"   , 0 , NAN          )
EXPR_OP_DEF(EXPR_O_EQLTR ,33       , u8"→"   , 0 , NAN          )
EXPR_OP_DEF(EXPR_O_ENDL  ,34       , u8";"   , -3, NAN          )
